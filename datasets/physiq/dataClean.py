...
if __name__ == "__main__":
    ...
    i, l, u = parser_folder_permuting('./datasets/physiq/segment_sessions_one_repetition_data_E2')
    np.save('./datasets/physiq/physiq_permute_e2.npy', {'inputs': i, 'labels': l, 'users': u})
    ...
    i, l, u = parser_folder_permuting('./datasets/physiq/segment_sessions_one_repetition_data_E4')
    np.save('./datasets/physiq/physiq_permute_e4.npy', {'inputs': i, 'labels': l, 'users': u})
